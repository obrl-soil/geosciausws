...
align_aoi <- function(aoi = NULL, product = NULL, snap = "out")
{
  ...
  orig <-
    c(ga_service_info$origin_x[which(ga_service_info$Short_Name == product)],
      ga_service_info$origin_y[which(ga_service_info$Short_Name == product)])
...
validate_aoi <- function(aoi = NULL, product = NULL) {
  ...
  ga_service_info <- NULL
  utils::data('ga_service_info', envir = environment())
  prd <- ga_service_info[which(ga_service_info$Short_Name == product), ]
